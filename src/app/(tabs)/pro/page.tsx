...
const ProPage = () => {
  const pageStore = useAtomValue(pageStoreAtom);
  return (
    <Suspense>
      <ViewTransition name="pro-page">
        ...
        >
          ...
          <div>
            ...
            toshiba netbook around 2010. i started programming in high school
            and found a particular passion for web development.
          </div>
          ...
          <div className={styles.has_canvas}>
            ...
            />
            <p>
              i specialize in node.js and frameworks like next.js and meteor
              with extensive experience in javascript/typescript, css/scss and,
              less obsessively, c++ and lua. i'm trying to always be learning
          ...
          <div className={styles.has_canvas}>
            <p>
              ...
              small orange thing (cat) named merlin. as merlin grows, so does
              his malicious intent. he may end up killing me and taking my place
              one day. there will be no way to tell.
            </p>
            <Canvas
